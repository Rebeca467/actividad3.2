...
public class Temperature_converter {
	...
	System.out.println(" Introduce un valor de Celsius a Fahrenheit....");
	System.out.println("  Introduce otro valor de Fahrenheit a Celsius....");
